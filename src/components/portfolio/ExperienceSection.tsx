...
const experiences = [
  {
    ...
    achievements: [
      "Architected component library with 150+ reusable components adopted by 4 teams (20+ engineers)",
      "Built rich text editor with bullet lists, headings, tables, iframe support, inline attachments, and embedded content",
      ...
      "Mentored 3 junior engineers on best practices and frontend architecture",
    ],
  },
  {
    company: "SuperOps",
  ...
  },
  {
    ...
    achievements: [
      "Owned end-to-end React.js development across Operations, Billing, and Vehicle Management, reducing manual work by 60%.",
      "Built responsive React UIs with REST APIs (Axios), improving state management and page load times by 15–25%.",
      "Implemented Keycloak SSO and RBAC, reducing access-related issues by 30%.",
      "Collaborated with backend and billing teams to integrate data models and automate business workflows.",
      "Developed Python/Selenium web scraping tools with retries and error handling, reducing Billing team's manual effort by 80%",
    ],
  },
];
